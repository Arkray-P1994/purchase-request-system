...
import { useDeleteAsset } from "../actions/delete";

export function DeleteAsset({ Id }: { Id: String | Number }) {
  const [dialogOpen, setDialogOpen] = React.useState(false);
  const { trigger } = useDeleteAsset({ id: Id });
